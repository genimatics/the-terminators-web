        ...
        <div className="grid grid-cols-1 gap-10 sm:gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="flex items-start gap-3 sm:gap-5">
              ...
              <div>
                <h4 className="hover:text-primary cursor-pointer text-base font-semibold text-white transition sm:text-lg">
                  {TEXTS.FOOTER.RECENT_POSTS.POSTS[0].TITLE}
                </h4>
                <p className="text-sm text-gray-400 sm:text-base">
                  {TEXTS.FOOTER.RECENT_POSTS.POSTS[0].DESCRIPTION}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 sm:gap-5">
              ...
              <div>
                <h4 className="hover:text-primary cursor-pointer text-base font-semibold text-white transition sm:text-lg">
                  {TEXTS.FOOTER.RECENT_POSTS.POSTS[1].TITLE}
                </h4>
                <p className="text-sm text-gray-400 sm:text-base">
                  {TEXTS.FOOTER.RECENT_POSTS.POSTS[1].DESCRIPTION}
                </p>
              </div>
            </div>
          </div>
