        ...
        <div className="relative z-10 mx-auto max-w-4xl">
          <div className="space-y-4 text-center">
            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">
              {TEXTS.PRIVACYHEADER.TITLE}
            </h1>
            <p className="text-lg font-medium opacity-90 sm:text-xl">
              {TEXTS.PRIVACYHEADER.SUBTITLE}
            </p>
          </div>
        </div>
      </div>
          ...
          <section className="mb-12 sm:mb-16">
            <div className="rounded-lg border border-border bg-secondary/50 p-6 backdrop-blur-sm sm:p-8">
              <p className="text-justify text-left text-base leading-relaxed text-foreground sm:text-lg">
                ...
                {' '}
                is committed to maintaining the highest standards in all our
                operations. Our policies reflect our dedication to quality,
                safety, ethical business practices, and respect for human rights.
              </p>
            </div>
          </section>
            ...
            <div className="p-6 sm:p-8 lg:p-10">
              ...
              <div className="space-y-4 sm:space-y-5">
                <div className="flex items-start gap-4">
                  <div className="mt-1 flex-shrink-0 rounded-lg bg-primary-foreground/20 p-2">
