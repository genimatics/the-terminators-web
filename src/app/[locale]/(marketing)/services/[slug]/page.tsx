      ...
      <section className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-3">
          ...
          <div className="space-y-8">
            <div className="rounded-2xl bg-gray-400 p-8 text-white">
              ...
              <Link href="/contact">
                <Button className="block w-full rounded-lg bg-white py-3 text-center font-semibold text-primary transition-colors hover:bg-gray-100">
                  Request Quote
                </Button>
              </Link>
            </div>
            ...
            <div className="rounded-2xl bg-white p-6 shadow-lg">
              ...
              <div className="space-y-3">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">+92 21 34830726-7</span>
                </div>
                <div className="flex items-center">
                  <svg className="mr-3 h-5 w-5 text-gray-400" fill="currentColor" viewBox="0 0 20 20">
